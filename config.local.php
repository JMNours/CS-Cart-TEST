...
$config['db_name'] = 'jenainzj_1';
$config['db_user'] = 'jenainzj_1';
$config['db_password'] = 'Password1';
...
$config['http_host'] = 'jenainzj.beget.tech';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'jenainzj.beget.tech';
$config['https_path'] = '';
